...
export function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 h-12 bg-white border-b border-gray-200 z-40 px-4 flex items-center justify-between select-none transition-transform duration-300 ease-in-out ${
