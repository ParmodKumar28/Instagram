...
<div class="container">
    ...
    <p>Dear ${userName},</p>
    <p>We received a request to reset your password for your account on Socialgram. Click the button below to reset your password:</p>
    ...
    <div class="footer">
        ...
        <p>Thank you,<br>Parmod Kumar • Socialgram</p>
    </div>
</div>
</body>
</html>
